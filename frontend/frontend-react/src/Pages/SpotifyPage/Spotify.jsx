  ...
  return (
    <div>
      ...
      <div className="Spotify-container">
        ...
        <div data-testid="recommendation-row">
          <RecommendationRow
            setCurrentTrack={setCurrentTrack}
        ...
        <div
          ...
          data-testid="spotify-airecommendation-row"
        >
          <AIRecommendationRow
            setTrackResult={setTrackResult}
            open={open}
            setOpen={setOpen}
            recommendationChange={recommendationChange}
            setRecommendationChange={setRecommendationChange}
          />
          <BallStatic />
        </div>
        <div className="SpotifyRowContainer" data-testid="spotify-spotify-row">
          <SpotifyRow
      ...
      >
        {isLoading ? (
          ...
          <Button sx={{ color: "#6ce946" }} onClick={() => loadMoreData()}>
            Load More Data
          </Button>
        )}
      </div>
      ...
      />
      <Player
        trackUri={getTrackUri(currentTrack)}
